...
export class SupplierPortalLayoutComponent implements OnInit {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Returns & Claims (RMA)', route: '/supplier-portal/returns', icon: 'M16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 4 2 4-2 4 2z' },
