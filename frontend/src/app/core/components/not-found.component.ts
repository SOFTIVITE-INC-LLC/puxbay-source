...
@Component({
  ...
  template: `
    <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:100vh; background:#0f172a; color:#fff; font-family:'Outfit',sans-serif; text-align:center; padding: 24px;">
      <h1 style="font-size:120px; font-weight:900; line-height:1; margin:0; background: #005b96; -webkit-background-clip:text; -webkit-text-fill-color:transparent;">404</h1>
      ...
      <a routerLink="/" style="display:inline-flex; align-items:center; justify-content:center; padding:14px 24px; background:#005b96; color:#fff; text-decoration:none; font-weight:700; font-size:14px; border-radius:10px; transition:all 0.2s; gap:8px;">
